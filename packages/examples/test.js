...
function jsx(type, props, key) {
  if (typeof type === "function" && type.constructor.name === "AsyncFunction") {
    ...
    return (0, import_jsx_runtime.jsx)(AsyncWrapper, props, key);
  }
...
var Counter = () => {
  ...
  return /* @__PURE__ */ jsxs("button", { onClick: () => setCounter(counter + 1), children: [
    "Counter: ",
    counter
  ] });
};
